// makeSortableTable wires <th data-sort="key"> headers to a row generator.
// rowsOf(sortKey, dir) must return an array of <tr> elements for the given sort.
// opts: { defaultKey, defaultDir }  defaultDir is 'asc' or 'desc'.
